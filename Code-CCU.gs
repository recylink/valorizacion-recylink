/**
 * ============================================================
 * RECYLINK · Apps Script del Sheet de CCU
 * ============================================================
 * Proyecto de Apps Script nuevo, para vincular al Sheet de CCU
 * (ID 1gChzhAy3wiXWAPr17OW4RypGMqY76dYRHLuK2wwvKR8). No existía Apps
 ...
 * Code-Ando.gs / Code-PMS.gs: writeObjetivos borra solo por
 ...
 * Ando/PMS, CCU NO usa las columnas Año ni Tons. CO2eq. evitadas (esas
 * 2 quedan exclusivas de Euro / del grupo original respectivamente).
 * ============================================================
 */
...
// sincronizar un objetivo calculado (trazabilidad, kpi_costo) borrara de
// paso las filas de objetivos "manual" (ej. Residuos Spot) de la MISMA
// sucursal+mes, aunque el sync nunca vuelve a mandarlas (calcObjetivos()
// nunca calcula un estado para tipo 'manual', asi que no se reinsertan).
// Ahora borra por empresa_id+mes+Objetivo exacto, para no arrastrar filas
// de otros objetivos.
