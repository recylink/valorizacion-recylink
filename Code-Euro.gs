...
function doPost(e) {
  try {
    ...
    else if (tipo === 'costoPresupuesto') writeCostoPresupuesto(ss, data);
...
// Lee "💰 Costo Presupuesto" completa como array de objetos, mismo formato
// que readTotalResiduosSheet_.
