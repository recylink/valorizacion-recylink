 ...
 * empresa (Sheet: 1uVIfSYPIbCvhaAJLe7Vjrw0drculbkcfhg67ONHhkes).
 *
 ...
 * — MISMO esquema y misma lista maestra de "Objetivos 2026" que
 * Constructora Vital (confirmado leyendo el Sheet real, 2026-09-11), así
 * que este archivo parte directamente de Code-Vital.gs (Año-aware desde
 * el día 1, sin necesidad de "descubrir y corregir" los mismos bugs de
 * nuevo) — solo se cambiaron nombre/color de empresa y los textos que
 * mencionaban "Vital" en comentarios/mensajes de usuario.
 *
 ...
 *     ?anio=2026 opcional) — mismo motor que Gespania/Socovesa/Vital, con
 *     "Objetivos 2026" como lista maestra y FGR comparativo (TODAS_OBRAS_FGR).
 *  3) El visor de Minutas (?minutas=1).
 *
 * Objetivos reales de Londres ("Objetivos 2026"): 100% trazabilidad ·
 * Segregar al menos 3 residuos (fierro, cartón y madera) · Valorizar un 2%
 * en peso · Cumplir normativa vigente sobre declaraciones · Conseguir
 * ecosistema dentro del marco legal.
 * ============================================================
 */
 ...
 * de título; colMap dice en qué columna va cada campo (en Londres el
...
var EMPRESA_NOMBRE  = "Constructora Londres";
var EMPRESA_COLOR   = "#6938EF";
var EMPRESA_COLOR_L = "#F4F3FF";
...
function construirEmpresas_(traza, val, cse, objetivosPorEmpresa, objetivosMaestro, totalResiduosPorEmpresa) {
  ...
  Object.keys(traza.sucursales).sort().forEach(function (empId) {
    ...
    // se trata como el objetivo de % de valorización global (ej. Londres:
    ...
    // un texto de % de valorización (Londres sí lo trae — "Valorizar un 2%
    // en peso" — así que esto no se duplica).
...
// de correrlo. En Londres el sub-encabezado es "Tema, Revisado, Detalle,
    ...
    sessions: [
      {
        ...
        headerRow: 1,
        dataStartRow: 3,
        colMap: { item:0, revisado:1, comentario:2, acuerdos:3, cumplido:4 }, // orden de Londres: Tema,Revisado,Detalle,Acuerdos,Resuelto
        items: [
