/**
 * ============================================================
 * RECYLINK · Apps Script del Sheet de PMS
 * ============================================================
 * Proyecto de Apps Script nuevo, para vincular al Sheet de PMS
 * (ID 1q1T543MVj9eA4bjbaysIRpr3eGf0fB_J5B1PekGBo6A). No existía Apps
 ...
 * Code-Ando.gs: writeObjetivos borra solo por empresa_id + mes exacto
 * (no por prefijo de empresa completo), soporte para
 * tipo:'totalResiduos', y doGet expone la hoja RESPEL propia del Sheet
 * (Residuo -> TRUE/FALSE).
 *
 ...
 * Ando, PMS NO usa las columnas Año ni Tons. CO2eq. evitadas (esas 2
 * quedan exclusivas de Euro / del grupo original respectivamente).
 * ============================================================
 */
